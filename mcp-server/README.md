...
- Use `highlight_investment_rows` when ChatGPT needs to visually highlight matching rows in the AfterTaxUS frontend; `select_investment_rows` remains as a compatibility alias.
