...
- Write tools support investment rows, investment checkbox updates, replacing all investment rows when intentionally populating from scratch, and reference-table maintenance. Do not expose this MCP server publicly without `MCP_AUTH_TOKEN` or equivalent access control.
