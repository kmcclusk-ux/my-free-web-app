          ...
          <tbody>
            {displayedRows.map((row) => {
              ...
              const investmentCells = {
                ...
                override: <td key="override" className="checkbox-cell investment-column--override">{derived?.incomeItem ? <div className="readonly-cell readonly-cell--text">N.A.</div> : <input type="checkbox" checked={row.overrideProposal || hasDifferentWhatIfAsset} onChange={(event) => onChange(row.id, "overrideProposal", event.target.checked)} />}</td>,
